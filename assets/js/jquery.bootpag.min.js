...
(function(h, q) {
  h.fn.bootpag = function(p) {
    ...
    return this.each(function() {
      var c, b, d = h(this);
      c = ['<ul class="', a.wrapClass, ' pagination-danger pagination-designs bootpag">'];
      a.prev && (c = c.concat(['<li data-lp="1" class="', a.prevClass, '"><a class="hidden" href="', g(1), '">', a.prev, "</a></li>"]));
      ...
      a.next && (b = a.leaps && a.total > a.maxVisible ? Math.min(a.maxVisible + 1, a.total) : 2, c = c.concat(['<li data-lp="', b, '" class="', a.nextClass, '"><a class="hidden" href="', g(b), '">', a.next, "</a></li>"]));
